...
var CommandBarSplitDisabledExample = /** @class */ (function (_super) {
    ...
    CommandBarSplitDisabledExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(CommandBar, { items: this.getItems(), overflowItems: this.getOverlflowItems(), overflowButtonProps: { ariaLabel: 'More commands' }, farItems: this.getFarItems(), ariaLabel: 'Use left and right arrow keys to navigate between commands' })));
    };
    return CommandBarSplitDisabledExample;
}(React.Component));
export { CommandBarSplitDisabledExample };
