...
var FocusTrapZoneBoxExample = /** @class */ (function (_super) {
    ...
    FocusTrapZoneBoxExample.prototype.render = function () {
        ...
        return (React.createElement(Stack, { tokens: { childrenGap: 8 } },
            ...
            React.createElement(Stack.Item, null,
                React.createElement(DefaultButton, { onClick: this._onButtonClickHandler, text: "Trap Focus" })),
            React.createElement(FocusTrapZone, { disabled: !useTrapZone },
                React.createElement(Stack, { horizontalAlign: "start", tokens: { childrenGap: 15 }, styles: {
                    ...
                    React.createElement(Link, { href: "https://bing.com" }, "Hyperlink inside trap zone")))));
    };
    return FocusTrapZoneBoxExample;
}(React.Component));
export { FocusTrapZoneBoxExample };
