...
var ExtendedPeoplePickerBasicExample = /** @class */ (function (_super) {
    ...
    ExtendedPeoplePickerBasicExample.prototype._renderExtendedPicker = function () {
        return (React.createElement(ExtendedPeoplePicker, { floatingPickerProps: this._floatingPickerProps, selectedItemsListProps: this._selectedItemsListProps, onRenderFloatingPicker: FloatingPeoplePicker, onRenderSelectedItems: SelectedPeopleList, className: this._classNames.picker, key: "normal", inputProps: {
...
export { ExtendedPeoplePickerBasicExample };
