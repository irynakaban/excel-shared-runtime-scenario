...
var CalloutContentBase = /** @class */ (function (_super) {
    ...
    function CalloutContentBase(props) {
        ...
        _this._dismissOnLostFocus = function (ev) {
            ...
            var clickedOutsideCallout = _this._hostElement.current && !elementContains(_this._hostElement.current, target);
                ...
                ((!_this._target && clickedOutsideCallout) ||
                    (ev.target !== _this._targetWindow &&
                        ...
                        (_this._target.stopPropagation ||
                            (!_this._target || (target !== _this._target && !elementContains(_this._target, target))))))) {
                _this.dismiss(ev);
            }
        };
    ...
    CalloutContentBase.prototype.render = function () {
        ...
        var content = (React.createElement("div", { ref: this._hostElement, className: this._classNames.container, style: visibilityStyle },
            React.createElement("div", tslib_1.__assign({}, getNativeProps(this.props, divProperties), { className: css(this._classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]), style: positions ? positions.elementPosition : OFF_SCREEN_STYLE, tabIndex: -1, 
                ...
                React.createElement(Popup, { role: role, ariaLabel: ariaLabel, ariaDescribedBy: ariaDescribedBy, ariaLabelledBy: ariaLabelledBy, className: this._classNames.calloutMain, onDismiss: this.dismiss, onScroll: onScroll, shouldRestoreFocus: true, style: overflowStyle }, children))));
        return content;
    };
