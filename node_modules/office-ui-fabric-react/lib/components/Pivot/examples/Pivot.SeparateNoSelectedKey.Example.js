    ...
    PivotSeparateNoSelectedKeyExample.prototype.render = function () {
        ...
        return (React.createElement("div", { style: { width: '50%', maxWidth: '500px' } },
            ...
            React.createElement("div", { style: {
                ...
                React.createElement(Pivot, { style: { flexGrow: 1 }, selectedKey: Object.keys(pivotItems).indexOf(this.state.selectedKey) >= 0 ? this.state.selectedKey : null, onLinkClick: this._handleLinkClick, headersOnly: true, getTabId: this._getTabId }, Object.keys(pivotItems).map(function (name) { return (React.createElement(PivotItem, { key: "pivotItemKey_" + name, headerText: name, itemKey: name })); })),
                React.createElement(IconButton, { iconProps: { iconName: 'Settings', style: { color: this.state.selectedKey === 'Settings' ? 'blue' : 'black' } }, onClick: this._handleSettingsIconClick })),
