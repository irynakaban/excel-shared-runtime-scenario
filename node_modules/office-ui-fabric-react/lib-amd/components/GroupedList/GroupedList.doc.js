define(["require", "exports", "react", "./examples/GroupedList.Basic.Example", "./examples/GroupedList.Custom.Example"], function (require, exports, React, GroupedList_Basic_Example_1, GroupedList_Custom_Example_1) {
    "use strict";
    ...
    var GroupedListBasicExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/GroupedList/examples/GroupedList.Basic.Example.tsx');
    var GroupedListCustomExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/GroupedList/examples/GroupedList.Custom.Example.tsx');
    exports.GroupedListPageProps = {
        ...
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/GroupedList/GroupedList.types.ts')],
