define(["require", "exports", "react", "./examples/ScrollablePane.Default.Example", "./examples/ScrollablePane.DetailsList.Example"], function (require, exports, React, ScrollablePane_Default_Example_1, ScrollablePane_DetailsList_Example_1) {
    "use strict";
    ...
    var ScrollablePaneDefaultExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ScrollablePane/examples/ScrollablePane.Default.Example.tsx');
    var ScrollablePaneDetailsListExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ScrollablePane/examples/ScrollablePane.DetailsList.Example.tsx');
