define(["require", "exports", "tslib", "react", "./examples/CommandBar.Basic.Example", "./examples/CommandBar.ButtonAs.Example", "./examples/CommandBar.CommandBarButtonAs.Example", "./examples/CommandBar.SplitDisabled.Example", "./examples/data"], function (require, exports, tslib_1, React, CommandBar_Basic_Example_1, CommandBar_ButtonAs_Example_1, CommandBar_CommandBarButtonAs_Example_1, CommandBar_SplitDisabled_Example_1, data_1) {
    "use strict";
    ...
    exports.CommandBarPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(CommandBar_SplitDisabled_Example_1.CommandBarSplitDisabledExample, tslib_1.__assign({}, cmdBarParamsTextAndIcons))
            }
        ],
