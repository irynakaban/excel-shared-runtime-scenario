define(["require", "exports", "tslib", "react", "../CommandBar/examples/data", "./examples/Callout.Basic.Example", "./examples/Callout.Nested.Example", "./examples/Callout.FocusTrap.Example", "./examples/Callout.Directional.Example", "./examples/Callout.Cover.Example"], function (require, exports, tslib_1, React, data_1, Callout_Basic_Example_1, Callout_Nested_Example_1, Callout_FocusTrap_Example_1, Callout_Directional_Example_1, Callout_Cover_Example_1) {
    "use strict";
    ...
    exports.CalloutPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(Callout_FocusTrap_Example_1.CalloutFocusTrapExample, tslib_1.__assign({}, cmdBarParamsTextAndIcons))
            },
            {
