define(["require", "exports", "react", "./examples/SearchBox.FullSize.Example", "./examples/SearchBox.Underlined.Example", "./examples/SearchBox.Disabled.Example", "./examples/SearchBox.CustomIcon.Example", "./examples/SearchBox.Small.Example"], function (require, exports, React, SearchBox_FullSize_Example_1, SearchBox_Underlined_Example_1, SearchBox_Disabled_Example_1, SearchBox_CustomIcon_Example_1, SearchBox_Small_Example_1) {
    ...
    var SearchBoxFullSizeExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/SearchBox/examples/SearchBox.FullSize.Example.tsx');
    ...
    var SearchBoxSmallExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/SearchBox/examples/SearchBox.Small.Example.tsx');
    exports.SearchBoxPageProps = {
        ...
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/SearchBox/SearchBox.types.ts')],
