define(["require", "exports", "react", "./examples/Dropdown.Basic.Example", "./examples/Dropdown.Controlled.Example", "./examples/Dropdown.ControlledMulti.Example", "./examples/Dropdown.Custom.Example", "./examples/Dropdown.Error.Example", "./examples/Dropdown.Required.Example"], function (require, exports, React, Dropdown_Basic_Example_1, Dropdown_Controlled_Example_1, Dropdown_ControlledMulti_Example_1, Dropdown_Custom_Example_1, Dropdown_Error_Example_1, Dropdown_Required_Example_1) {
    "use strict";
    ...
    var DropdownBasicExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Basic.Example.tsx');
    ...
    var DropdownControlledExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Controlled.Example.tsx');
    ...
    var DropdownControlledMultiExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.ControlledMulti.Example.tsx');
    ...
    var DropdownCustomExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Custom.Example.tsx');
    ...
    var DropdownErrorExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Error.Example.tsx');
    ...
    var DropdownRequiredExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Required.Example.tsx');
    exports.DropdownPageProps = {
        ...
        propertiesTablesSources: [
            ...
            require('!raw-loader!office-ui-fabric-react/src/utilities/selectableOption/SelectableDroppableText.types.ts')
        ],
