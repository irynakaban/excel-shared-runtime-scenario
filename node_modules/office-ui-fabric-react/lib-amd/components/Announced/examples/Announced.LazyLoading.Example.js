define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Announced", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Image", "office-ui-fabric-react/lib/FocusZone", "office-ui-fabric-react/lib/Text", "office-ui-fabric-react/lib/Stack", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/ProgressIndicator", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Announced_1, Utilities_1, Image_1, FocusZone_1, Text_1, Stack_1, Button_1, ProgressIndicator_1, Styling_1) {
    "use strict";
            ...
            return (React.createElement(Stack_1.Stack, { tokens: stackTokens },
                ...
                React.createElement(FocusZone_1.FocusZone, null,
                    React.createElement(Stack_1.Stack, { horizontal: true, wrap: true, 
                        ...
                        inner: function (render) { return render(function (_, props) { return React.createElement("ul", { className: props.className }, props.children); }); }, tokens: photoStackTokens, styles: photoStackStyles }, this._renderPhotos()))));
        };
