            ...
            _this._onRenderItemColumn = function (item, index, column) {
                ...
                if (column.key === 'name') {
                    return (React.createElement("div", null,
                        fieldContent,
                        React.createElement(Button_1.IconButton, { menuIconProps: { iconName: 'MoreVertical' }, role: "button", "aria-haspopup": true, "aria-label": "Show actions", styles: { root: { float: 'right', height: 'inherit' } }, menuProps: {
                                items: [
                                    {
                                        key: 'delete',
                                        text: 'Delete',
