define(["require", "exports", "react", "./examples/List.Basic.Example", "./examples/List.Grid.Example", "./examples/List.Scrolling.Example", "./examples/List.Ghosting.Example", "../../utilities/exampleData"], function (require, exports, React, List_Basic_Example_1, List_Grid_Example_1, List_Scrolling_Example_1, List_Ghosting_Example_1, exampleData_1) {
    "use strict";
