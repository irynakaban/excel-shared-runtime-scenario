define(["require", "exports", "react", "./examples/ChoiceGroup.Basic.Example", "./examples/ChoiceGroup.Label.Example", "./examples/ChoiceGroup.Custom.Example", "./examples/ChoiceGroup.Image.Example", "./examples/ChoiceGroup.Icon.Example"], function (require, exports, React, ChoiceGroup_Basic_Example_1, ChoiceGroup_Label_Example_1, ChoiceGroup_Custom_Example_1, ChoiceGroup_Image_Example_1, ChoiceGroup_Icon_Example_1) {
    "use strict";
    ...
    var ChoiceGroupBasicExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ChoiceGroup/examples/ChoiceGroup.Basic.Example.tsx');
    ...
    var ChoiceGroupLabelExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ChoiceGroup/examples/ChoiceGroup.Label.Example.tsx');
    ...
    var ChoiceGroupIconExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ChoiceGroup/examples/ChoiceGroup.Icon.Example.tsx');
    exports.ChoiceGroupPageProps = {
        ...
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/ChoiceGroup/ChoiceGroup.types.ts')],
