define(["require", "exports", "react", "./examples/Rating.Basic.Example", "./examples/Rating.ButtonControlled.Example"], function (require, exports, React, Rating_Basic_Example_1, Rating_ButtonControlled_Example_1) {
    ...
    var RatingBasicExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/Rating/examples/Rating.Basic.Example.tsx');
    ...
    exports.RatingPageProps = {
        ...
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/Rating/Rating.types.ts')],
