define(["require", "exports", "tslib", "react", "../Autofill/index", "../../Utilities", "../../Callout", "../../Checkbox", "../../Button", "../../common/DirectionalHint", "./ComboBox.styles", "./ComboBox.classNames", "../../KeytipData", "../../Label", "../../utilities/selectableOption/SelectableOption.types"], function (require, exports, tslib_1, React, index_1, Utilities_1, Callout_1, Checkbox_1, Button_1, DirectionalHint_1, ComboBox_styles_1, ComboBox_classNames_1, KeytipData_1, Label_1, SelectableOption_types_1) {
    "use strict";
    ...
    var ComboBox = /** @class */ (function (_super) {
        ...
        ComboBox.prototype.render = function () {
            ...
            return (React.createElement("div", tslib_1.__assign({}, divProps, { ref: this._root, className: this._classNames.container }),
                ...
                React.createElement(KeytipData_1.KeytipData, { keytipProps: keytipProps, disabled: disabled }, function (keytipAttributes) { return (React.createElement("div", { "data-ktp-target": keytipAttributes['data-ktp-target'], ref: _this._comboBoxWrapper, id: id + 'wrapper', className: _this._classNames.root },
                    ...
                    React.createElement(Button_1.IconButton, { className: 'ms-ComboBox-CaretDown-button', styles: _this._getCaretButtonStyles(), role: "presentation", "aria-hidden": isButtonAriaHidden, "data-is-focusable": false, tabIndex: -1, onClick: _this._onComboBoxClick, iconProps: buttonIconProps, disabled: disabled, checked: isOpen }))); }),
                (persistMenu || isOpen) &&
        ...
        ComboBox.prototype._processInputChangeWithFreeform = function (updatedValue) {
            ...
            if (updatedValue === '') {
                var items = currentOptions
                    ...
                    .filter(function (option) { return option.itemType !== SelectableOption_types_1.SelectableOptionMenuItemType.Header && option.itemType !== SelectableOption_types_1.SelectableOptionMenuItemType.Divider; })
        ...
        ComboBox.prototype._getNextSelectableIndex = function (index, searchDirection) {
            ...
            if (option.itemType === SelectableOption_types_1.SelectableOptionMenuItemType.Header || option.itemType === SelectableOption_types_1.SelectableOptionMenuItemType.Divider) {
        ...
        ComboBox.prototype._getCurrentOptionStyles = function (item) {
            ...
            return ComboBox_styles_1.getOptionStyles(this.props.theme, customStylesForAllOptions, customStylesForCurrentOption, this._isPendingOption(item));
        };
        /**
