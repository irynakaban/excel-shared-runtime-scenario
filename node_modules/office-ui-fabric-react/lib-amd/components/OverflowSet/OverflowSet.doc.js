define(["require", "exports", "react", "./examples/OverflowSet.Custom.Example", "./examples/OverflowSet.Basic.Example", "./examples/OverflowSet.Vertical.Example"], function (require, exports, React, OverflowSet_Custom_Example_1, OverflowSet_Basic_Example_1, OverflowSet_Vertical_Example_1) {
    "use strict";
    ...
    var OverflowSetCustomExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/OverflowSet/examples/OverflowSet.Custom.Example.tsx');
    ...
    var OverflowSetBasicExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/OverflowSet/examples/OverflowSet.Basic.Example.tsx');
    ...
    var OverflowSetVerticalExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/OverflowSet/examples/OverflowSet.Vertical.Example.tsx');
    exports.OverflowSetPageProps = {
        ...
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/OverflowSet/OverflowSet.types.ts')],
