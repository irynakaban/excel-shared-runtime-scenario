...
var CalloutContentBase = /** @class */ (function (_super) {
    ...
    function CalloutContentBase(props) {
        ...
        _this._dismissOnLostFocus = function (ev) {
            ...
            var clickedOutsideCallout = _this._hostElement.current && !Utilities_1.elementContains(_this._hostElement.current, target);
                ...
                ((!_this._target && clickedOutsideCallout) ||
                    (ev.target !== _this._targetWindow &&
                        ...
                        (_this._target.stopPropagation ||
                            (!_this._target || (target !== _this._target && !Utilities_1.elementContains(_this._target, target))))))) {
                _this.dismiss(ev);
            }
        };
