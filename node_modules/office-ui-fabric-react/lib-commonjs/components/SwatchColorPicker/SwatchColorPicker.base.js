...
var SwatchColorPickerBase = /** @class */ (function (_super) {
    ...
    function SwatchColorPickerBase(props) {
        ...
        if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'production') {
            Utilities_1.warnMutuallyExclusive('SwatchColorPicker', _this.props, {
                focusOnHover: 'onHover'
            });
            Utilities_1.warnConditionallyRequiredProps('SwatchColorPicker', _this.props, ['focusOnHover'], 'mouseLeaveParentSelector', !!_this.props.mouseLeaveParentSelector);
        }
        _this.isNavigationIdle = true;
    ...
    SwatchColorPickerBase.prototype.render = function () {
        ...
        return (React.createElement(Grid_1.Grid, tslib_1.__assign({}, this.props, { items: colorCells.map(function (item, index) {
