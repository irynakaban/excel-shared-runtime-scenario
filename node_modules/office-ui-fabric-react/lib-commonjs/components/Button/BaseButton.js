...
var BaseButton = /** @class */ (function (_super) {
    ...
    function BaseButton(props, rootClassName) {
        ...
        if (props.persistMenu && props.menuProps) {
            ...
            menuProps = tslib_1.__assign({}, props.menuProps, { hidden: true });
        }
        _this.state = {
            menuProps: menuProps
        };
    ...
    BaseButton.prototype._onRenderSplitButtonContent = function (tag, buttonProps) {
        ...
        var classNames = getSplitButtonClassNames
            ...
            : styles && SplitButton_classNames_1.getClassNames(styles, !!disabled, this._isExpanded, !!checked);
        Utilities_1.assign(buttonProps, {
            onClick: undefined,
            tabIndex: -1,
